          ...
          {words.length > 0 && (
            <div className="relative" ref={exportRef}>
              <button
                ...
                disabled={exporting}
                className="flex items-center gap-1 bg-surface-container-high text-on-surface px-3 py-2 rounded-2xl text-sm font-bold active:scale-95 transition-transform"
              >
                <span className="material-symbols-outlined text-base">{exporting ? "hourglass_empty" : "download"}</span>
                <span className="hidden sm:inline">Export</span>
              </button>
              {exportOpen && (
                <div className="absolute right-0 top-full mt-1 bg-surface-container-lowest rounded-2xl shadow-lg border border-surface-container-high z-50 min-w-[140px] overflow-hidden">
